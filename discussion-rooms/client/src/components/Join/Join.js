...
import "./Join.css";
import Metakart from "../../icons/Metakart.png"; 
...
const Join = ({ location }) => {
      ...
      <div>
        ...
        <div style={{ textAlign: "left", fontSize: "2rem" }} className="mt-20">
          <span
            ...
            style={{ marginRight: 0, color: "#1474E1" }}
          >
            {" "}
  ...
  const GenerateRoomOrJoinRoom = () => {
    return (
      <>
        <button
          className="button mt-20 fontprime bgbutton"
          type="submit"
          onClick={() => {
            toggle(3);
          }}
      ...
      <div className="helptext ">
        <p>
          ...
          <ul>
            ...
            <li>
              Click <i className="fa fa-share-alt" aria-hidden="true"></i> for
              sharing join link with friends.
            </li>
            <li>
              Click <i className="fa fa-clone" aria-hidden="true"></i> for
              copying room ID
            </li>
            <li>
              Join the room and study together using text and voice channels. No
              registration required.{" "}
            </li>
          </ul>
        </p>
        <p>
          <u>About</u> : The application aims to put text and voice channels on
          the same page, so that collaboration with friends while studying
          becomes easy.
        </p>
        <div
          style={{
  ...
  return (
    <div className="joinOuterContainer bgprime">
      ...
      <img src={Metakart} height={60} alt="."></img>
        <h1
        ...
        <div className="belowHeading">{getAppropriateComponent(state)}</div>
      </div>
    </div>
  );
};
